...
\cvitem{Expériences professionnelles}
    \begin{cvlist}{}
        \item[2012]     Stage chez \textbf{Gostai} (Paris, France)
        \item[(6 mois)] \alin Conception et réalisation d'une interface utilisateur pour un robot
    ...
    \saut
	\item[2009]	Stage chez \textbf{Thales Air Defence}
