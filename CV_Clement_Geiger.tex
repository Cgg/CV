...
\cvitem{Formation}
    \begin{cvlist}{}
        \item[2011]             Échange Erasmus à \textbf{KTH} (Stockholm, Suède)
...
\cvitem{Expériences professionnelles}
    \begin{cvlist}{}
        \item[2012]     Emploi chez \textbf{Aldebaran Robotics} au sein de
          l'équipe \textit{Desktop}
        \item[2012]     Stage chez \textbf{Gostai} puis \textbf{Aldebaran
          Robotics} (Paris, France)
        \item[(6 mois)] \alin Conception et réalisation d'une interface
          utilisateur pour un robot, travail sur la suite logicielle d'Aldebaran
        \item           \alin \textit{Technologies}: Qt, C++, Python, Build System, git
    \saut
        \item[2011]     Stage chez \textbf{Schlumberger} (Abingdon,
        Royaume-Uni)
    ...
    \saut
        \item[2010]     Stage chez \textbf{Philips Applied Technologies}
        (Eindhoven, Pays-Bas)
...
\cvitem{Compétences}
	...
	\item			Bas niveau, embarqué : C, C sur
        ...
        \item    Intelligence artificielle, Machine Learning, Datamining, traitement
        d'images, théorie du signal
    \saut
...
\vskip 1mm
        \textbf{Photographie}: pratique argentique (prise de vue, développement et
  tirage)
